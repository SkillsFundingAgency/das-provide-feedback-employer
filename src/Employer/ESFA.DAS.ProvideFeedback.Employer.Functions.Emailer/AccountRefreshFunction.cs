...
//            [ServiceBus("%ProcessActiveFeedbackQueueName%", Connection = "ServiceBusConnection", EntityType = ServiceBusEntityType.Queue)]ICollector<GroupedFeedbackRefreshMessage> queue,
//            ILogger log)
//        {
